...
#if !defined(_MSC_VER)
    auto const trace = ex.getTrace();
    EXPECT_THAT(trace, HasSubstr("tensorrt_llm::common::TllmException::TllmException"));
#endif
}
...
#if !defined(_MSC_VER)
        EXPECT_THAT(out, HasSubstr("tensorrt_llm::common::TllmException::TllmException"));
