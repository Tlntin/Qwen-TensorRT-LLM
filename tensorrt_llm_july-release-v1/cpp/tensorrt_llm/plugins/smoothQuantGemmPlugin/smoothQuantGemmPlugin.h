...
public:
    ...
    SmoothQuantGemmPlugin(bool peChannelScaling, bool perTokenScaling, nvinfer1::DataType type);
...
private:
    void init(bool perChannelScaling, bool perTokenScaling, nvinfer1::DataType type);
...
private:
    ...
    tensorrt_llm::common::QuantOption m_quantOption;
