...
class SelfAttention(torch.nn.Module):
    ...
    def __init__(self,
        ...
        self.rotary_emb = RotaryEmbedding(
            ...
            if position_encoding_2d else self.hidden_size //
...
class GLMBlock(torch.nn.Module):
    ...
    def forward(
        ...
        # Self attention.
        attention_outputs = self.attention(attention_input,
                                           position_ids,
                                           attention_mask=attention_mask,
                                           layer_id=layer_id,
                                           layer_past=layer_past,
...
class ChatGLMModel(ChatGLMPreTrainedModel):
    ...
    def __init__(self, config: ChatGLMConfig, empty_init=True):
        ...
        self.word_embeddings = init_method(torch.nn.Embedding,
        ...
        def get_layer(layer_id):
            return GLMBlock(self.hidden_size,
                            self.num_attention_heads,
        ...
        self.final_layernorm = LayerNorm(self.hidden_size,
...
class ChatGLMForConditionalGeneration(ChatGLMPreTrainedModel):
    ...
    def __init__(self, config: ChatGLMConfig, empty_init=True):
        ...
        self.lm_head = init_method(nn.Linear,
                                   config.hidden_size,
                                   config.vocab_size,
                                   bias=False,
                                   dtype=torch.half)
    ...
    def quantize(self, bits: int, empty_init=False, **kwargs):
        ...
        self.transformer = quantize(self.transformer,
                                    bits,
                                    empty_init=empty_init,
                                    **kwargs)
        return self
