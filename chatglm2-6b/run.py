...
def build_inputs(tokenizer, query: str, history: list[tuple[str, str]] = None):
    ...
    inputs = tokenizer([prompt], return_tensors="pt", padding=True)['input_ids'].int().contiguous().cuda()
    return inputs
...
if __name__ == '__main__':
    ...
    tokenizer = transformers.AutoTokenizer.from_pretrained(
        "/data/zhaohb/chatglm2-6b/a6d54fac46dff2db65d53416c207a4485ca6bd40/", trust_remote_code=True)
    input_ids = None
    input_text = None
