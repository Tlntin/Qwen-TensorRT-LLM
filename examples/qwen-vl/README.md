...
- Build TRT-LLM engines with int8 (only need to add --max_prompt_embedding_table_size)
...
4. Run Qwen-VL pipeline
	...
	--qwen_engine_dir=./trt_engines/Qwen-VL-7B-fp16/ \ ## int8 : --qwen_engine_dir=trt_engines_int8/Qwen-VL-7B-int8
	--vit_engine_dir=./plan/
    ```
