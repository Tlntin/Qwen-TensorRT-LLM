...
def main(args):
    ...
    tokenizer.pad_token_id = pad_id = end_id = gen_config["eos_token_id"][0]
    ...
    def summarize_tensorrt_llm(datapoint):
        ...
        for i in range(batch_size):
            ...
            input_id = input_ids.type(torch.int32)
    ...
    def summarize_hf(datapoint):
        ...
        if batch_size > 1:
            ...
            line_encoded = tokenizer(
                ...
                padding=True,
                truncation=True,
            )["input_ids"][:, -max_input_len:].type(torch.int64)
        else:
            line[0] = line[0] + ' TL;DR: '
            line[0] = line[0].strip()
            ...
            input_ids = tokenizer([text], return_tensors="pt").input_ids
            line_encoded = input_ids[:, -max_input_len:].type(torch.int64)
