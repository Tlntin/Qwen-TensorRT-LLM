...
from utils.utils import DEFAULT_HF_MODEL_DIRS, load_tokenizer, read_model_name
    ...
    if test_trt_llm:
        ...
        if not args.use_py_session:
            runner_kwargs.update(
                ...
                max_output_len=default_config.max_new_tokens,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_len', type=int, default=default_config.max_output_len)
